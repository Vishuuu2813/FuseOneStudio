  ...
  return (
    <PageWrapper>
      ...
      <section style={{
        ...
        >
          AI Services, <em style={{ color: 'var(--c-accent)', fontStyle: 'italic' }}>engineered</em> for impact
        </motion.h1>
        <motion.p
          variants={fadeUp} initial="hidden" animate="visible"
          style={{ fontSize: '1rem', color: 'var(--c-muted)', maxWidth: '520px', margin: '0 auto', lineHeight: 1.7 }}
        >
          From intelligent workflow automation to full-stack SaaS builds — every service we offer is designed to deliver measurable ROI, not just outputs.
        </motion.p>
      </section>
