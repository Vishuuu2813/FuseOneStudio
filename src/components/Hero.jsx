...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Hairline grid overlay for texture */}
      <div style={{
        position: 'absolute',
        inset: 0,
      ...
      <div style={{
        ...
        maxWidth: '1200px',
        margin: '0 auto',
        padding: 'clamp(3rem, 8vh, 6rem) clamp(1.25rem, 5vw, 5rem)',
        display: 'grid',
        ...
        <div>
          ...
          >
            FuseOne Studios helps businesses harness the power of AI —
            custom automations, intelligent integrations, and SaaS builds
          ...
          >
            {[['1000+', 'Happy Users'], ['500+', 'Hrs Saved/Mo'], ['4.8★', 'Avg Rating']].map(([num, label]) => (
              <div key={label} style={{ display: 'flex', flexDirection: 'column', gap: '0.1rem' }}>
                <span style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '1.25rem', color: 'var(--c-accent)', letterSpacing: '-0.02em' }}>{num}</span>
        ...
        {/* ── Right column: Icon + floating cards ── */}
        <motion.div
        ...
        >
          ...
          {/* Main Icon — cinematic breathe only, NO spin/bounce */}
          <img
            src={iconImg}
            alt="FuseOne Studios"
            style={{
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 4px 24px rgba(109,40,217,0.1), 0 1px 3px rgba(0,0,0,0.06)',
              zIndex: 2,
            }}
          >
            <div style={{ fontFamily: 'var(--font-display)', fontSize: '1.5rem', fontWeight: 800, color: 'var(--c-accent)', letterSpacing: '-0.03em' }}>70%</div>
            <div style={{ fontSize: '0.65rem', color: 'var(--c-muted)', fontWeight: 500, marginTop: '0.1rem' }}>Faster Workflows</div>
          </motion.div>
          ...
          >
            <div style={{ fontFamily: 'var(--font-display)', fontSize: '1.5rem', fontWeight: 800, color: 'var(--c-accent)', letterSpacing: '-0.03em' }}>92%</div>
            <div style={{ fontSize: '0.65rem', color: 'var(--c-muted)', fontWeight: 500, marginTop: '0.1rem' }}>AI Accuracy</div>
          </motion.div>
          ...
          >
            <div style={{ fontFamily: 'var(--font-display)', fontSize: '1.5rem', fontWeight: 800, color: '#fff', letterSpacing: '-0.03em' }}>4.8★</div>
            <div style={{ fontSize: '0.65rem', color: 'rgba(255,255,255,0.7)', fontWeight: 500, marginTop: '0.1rem' }}>Client Rating</div>
          </motion.div>
        </motion.div>
      </div>
      ...
      >
        <motion.div
          style={{ width: 1, height: 40, background: 'linear-gradient(to bottom, var(--c-accent), transparent)', originY: 0 }}
